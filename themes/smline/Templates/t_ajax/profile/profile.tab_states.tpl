	...
	<div class="box_title">Estados</div>
		<div class="profile_status clearfix">
			...
			<div class="new_status_text clearfix">
				<div class="floatL">
					<a href="{$web.url}/{$user->nick}"><img src="{$web.avatar}/{$user->uid}_50.jpg?{$user->uid.u_last_avatar}" class="avatar-2"/></a>
				</div>
			...
			<div class="new_status_types">
				<div class="my-shout-attach menu clearfix attach-i_vid" style="display: none;">
					...
					<div class="add-url clearfix">
						<label>URL</label>
						<form>
							<input class="inp_text" type="text" name="import" placeholder="URL del v&iacute;deo" autocomplete="off">
			...
			<div class="new_status_buttons">
				<div class="floatL margin-top-5 buttons_adjs">
					...
					<a href="#" onclick="states.adj('vid', $(this)); return false;" class="button_1 stip" title="Publicar v&iacute;deo">
				...
				<div class="list_status clearfix" id="status-id-{$s.s_id}">
					...
					<div class="floatR list_status_right">
						...
						<div class="s_comments_actions clearfix" id="s-comment-{$s.s_id}" style="display:none">
							...
							<a href="#" onclick="states.show_comments({$s.s_id}, $(this)); return false;" class="show_all_comments"><i class="comments"></i>Mostrar {$s.s_comments-2} comentario{if ($s.s_comments-2) > 1}s{/if} m&aacute;s</a>
							{/if}
							<div class="floatL">
