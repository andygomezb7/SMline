var CROSSHAIRS_LOCATION = '/themes/'+global_data.theme+'/css/images/crosshairs.png';
var HUE_SLIDER_LOCATION = '/themes/'+global_data.theme+'/css/images/h.png';
var HUE_SLIDER_ARROWS_LOCATION = '/themes/'+global_data.theme+'/css/images/position.png';
var SAT_VAL_SQUARE_LOCATION = '/themes/'+global_data.theme+'/css/images/sv.png';
var BUTON_CLOSE_LOCATION= '/themes/'+global_data.theme+'/css/images/close.jpg';
...
buttonCloseImg.width = 50;
buttonCloseImg.height = 17;
buttonCloseImg.innerHTML = 'CERRAR';
buttonCloseImg.style.color = '#0D42E9';
...
function startColorPicker(inputObj)
{
	  hideColorPicker();
	   ...
	   color_picker_div.style.left = (colorPickerGetLeftPos(inputObj)-65) + 'px';
	   color_picker_div.style.width='250px';
	   color_picker_div.style.heigth='180px';
	   color_picker_div.style.top = (colorPickerGetTopPos(inputObj)-10) + inputObj.offsetHeight + 2 + 'px';
...
function change_color(obj, obj2, css_e, extra){
	var val = $(obj).val();
	if(extra) $(obj2).css(css_e, extra+val);
	else $(obj2).css(css_e, val);
}

function change_back(obj, obj2, icon){
	var val = $(obj).val();
	if(val) $(obj2).css('background-image', 'url(/css/img/icons/'+icon+'/'+val+')');
	else $(obj2).css('background-image', '');
}