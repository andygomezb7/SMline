...
class Smarty extends Smarty_Internal_TemplateBase
{
	...
	public $cache_dir = 'PHP/cache';
	public $templates_dir = 'themes/smline/Templates';
    ...
    public function __construct()
    {
		...
		$this->templates_dir = 'themes' . DS . $web['theme'] . DS . 'Templates';
        $this->start_time = microtime(true);
        $this->setTemplateDir('.' . DS . $this->templates_dir . DS)
            ->setCompileDir('.' . DS . $this->cache_dir . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir('.' . DS . $this->cache_dir . DS)
